	...
	<div id="ajaxCategory">
		...
		<div id="all">
			<div id="content">
				...
				out.print("btn-outline-secondary");%> ">Tất cả</a><span>sản phẩm</span>
											</div>
											<div class="products-sort-by mt-2 mt-lg-0">
												<strong>Sắp xếp</strong> <select name="sort-by"
									...
									<div class="col-lg-3 col-md-4">
										<div class="product">
											<div class="flip-container">
												<div class="flipper">
													<div class="front">
														<a href="productController?product_id=${product.id}"><img style="height: 337px; width: 253px;"
											...
											<a href="productController?product_id=${product.id}"
												class="invisible"><img style="height: 337px; width: 253px;"
												src="././template/user/img/${product.avatar}" alt=""
												class="img-fluid"></a>
											<div class="text">
												<h3>
