									...
									<form
										...
										<div class="products-number">
											<strong>Show</strong><a id="5"
												href="SearchCategoryController?str=<%=request.getParameter("str")%>&page=1&maxInEachPage=5&sortMode=<%=sortMode %>" 
												class="btn btn-sm <% if (maxInEachPage == 5) out.print("btn-primary"); else out.print("btn-outline-secondary"); %>">5</a><a
												href="SearchCategoryController?str=<%=request.getParameter("str")%>&page=1&maxInEachPage=20&sortMode=<%=sortMode %>"
												class="btn btn-sm <% if (maxInEachPage == 20) out.print("btn-primary"); else out.print("btn-outline-secondary"); %> ">20</a><a
												href="SearchCategoryController?str=<%=request.getParameter("str")%>&page=1&maxInEachPage=1000&sortMode=<%=sortMode %>"
									...
									<div class="product">
										<div class="flip-container">
											<div class="flipper">
												<div class="front">
													<a
														href="productController?product_id=${product.id}"><img
														src="././template/user/img/${product.avatar}" alt="" class="img-fluid"></a>
												</div>
												<div class="back">
													<a
														href="productController?product_id=${product.id}"><img
										...
										<a
											href="productController?product_id=${product.id}"
											class="invisible"><img src="././template/user/img/${product.avatar}" alt=""
											class="img-fluid"></a>
										<div class="text">
											<h3>
												<a
													href="productController?product_id=${product.id}">${product.name}</a>
											</h3>
											<p class="price">
												<del></del>
												${product.price}VND
							...
							<nav aria-label="Page navigation example"
								...
								<ul class="pagination">
									...
									<%
										...
										if (currentPage ==1){
											out.print("<li class='page-item'><a href='SearchCategoryController?str="+ request.getParameter("str")+"&page=1&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>«</span><span class='sr-only'>Previous</span></a></li>");
										} else {
											out.print("<li class='page-item'><a href='SearchCategoryController?str="+ request.getParameter("str")+"&page="+(currentPage-1)+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>«</span><span class='sr-only'>Previous</span></a></li>");
										}
										for (int i = 1; i <= totalPage; i++) {
											if (i!= currentPage){
												out.print("<li class='page-item'><a href='SearchCategoryController?str="+ request.getParameter("str")+"&page="+i+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' class='page-link'>" + i + "</a></li>");
											} else {
												out.print("<li class='page-item active'><a href='SearchCategoryController?str="+ request.getParameter("str")+"&page="+i+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' class='page-link'  >" + i + "</a></li>");
											}
										}
										if (currentPage ==totalPage){
											out.print("<li class='page-item'><a href='SearchCategoryController?str="+ request.getParameter("str")+"&page="+(currentPage)+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>»</span><span class='sr-only'>Next</span></a></li>");
										} else {
											out.print("<li class='page-item'><a href='SearchCategoryController?str="+ request.getParameter("str")+"&page="+(currentPage+1)+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>»</span><span class='sr-only'>Next</span></a></li>");
										}
