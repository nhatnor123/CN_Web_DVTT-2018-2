    ...
    *** COPYRIGHT ***
	...
	<script src="././template/user/vendor/jquery.cookie/jquery.cookie.js"> </script>
	<script src="././template/user/vendor/owl.carousel/owl.carousel.min.js"></script>
	<script src="././template/user/vendor/owl.carousel2.thumbs/owl.carousel2.thumbs.js"></script>
	<script src="././template/user/js/front.js"></script>
