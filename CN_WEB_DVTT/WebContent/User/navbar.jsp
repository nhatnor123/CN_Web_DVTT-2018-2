				...
				<div class="row">
					<div class="col-lg-6 offer mb-3 mb-lg-0">
						<c:if test="${user ne null }">
							<a href="#" class="ml-1"><img src="img/${user.avatar }" alt="${user.avatar }" style="width: 20px; height: 20px;" class="rounded-circle img-fluid"> Chào mừng ${user.name }</a>
						</c:if>
					</div>
						...
						<ul class="menu list-inline mb-0">
							...
							<c:choose>
								<c:when test="${user ne null }">
									<li class="list-inline-item"><a href="/CN_WEB_DVTT/User/Login?logout=yes">Đăng xuất</a></li>
									<li class="list-inline-item"><a href="customer-account.jsp">Tài khoản của bạn</a></li>
								</c:when>
									...
									<div class="row">
										<div class="col-md-6 col-lg-3">
											...
											<ul class="list-unstyled mb-3">
												...
												<li class="nav-item"><a
													href="/CN_WEB_DVTT/User/CategoryController?category_id=<%=c.getId()%>&sex=<%=c.getSex()%>"
