							...
							<div class="col-lg-3 col-md-6">
								<div class="product">
									<div class="flip-container">
										<div class="flipper">
											<div class="front">
												<a href="productController?product_id=${product.id}"><img src="././template/user/img/${product.avatar}" alt=""
													class="img-fluid"></a>
											</div>
											<div class="back">
												<a href="productController?product_id=${product.id}"><img src="././template/user/img/${product.avatar}"
													alt="" class="img-fluid"></a>
											</div>
										</div>
									</div>
									<a href="productController?product_id=${product.id}" class="invisible"><img
									...
									<div class="text">
										...
										<p class="buttons">
											<a href="productController?product_id=${product.id}" class="btn btn-outline-secondary">View
												detail</a>
										</p>
									</div>
									<!-- /.text-->
