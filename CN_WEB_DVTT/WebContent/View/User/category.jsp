							...
							<nav aria-label="Page navigation example"
								...
								<ul class="pagination">
									...
									<%
										...
										if (currentPage ==1){
											out.print("<li class='page-item'><a href='CategoryController?category_id="+ request.getParameter("category_id")+"&sex="+request.getParameter("sex")+"&page=1&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>«</span><span class='sr-only'>Previous</span></a></li>");
										} else {
											out.print("<li class='page-item'><a href='CategoryController?category_id="+ request.getParameter("category_id")+"&sex="+request.getParameter("sex")+"&page="+(currentPage-1)+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>«</span><span class='sr-only'>Previous</span></a></li>");
										}
										for (int i = 1; i <= totalPage; i++) {
											if (i!= currentPage){
												out.print("<li class='page-item'><a href='CategoryController?category_id="+ request.getParameter("category_id")+"&sex="+request.getParameter("sex")+"&page="+i+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' class='page-link'>" + i + "</a></li>");
											} else {
												out.print("<li class='page-item active'><a href='CategoryController?category_id="+ request.getParameter("category_id")+"&sex="+request.getParameter("sex")+"&page="+i+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' class='page-link'  >" + i + "</a></li>");
											}
										}
										if (currentPage ==totalPage){
											out.print("<li class='page-item'><a href='CategoryController?category_id="+ request.getParameter("category_id")+"&sex="+request.getParameter("sex")+"&page="+(currentPage)+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>»</span><span class='sr-only'>Next</span></a></li>");
										} else {
											out.print("<li class='page-item'><a href='CategoryController?category_id="+ request.getParameter("category_id")+"&sex="+request.getParameter("sex")+"&page="+(currentPage+1)+"&maxInEachPage="+request.getParameter("maxInEachPage")+"&sortMode="+sortMode+"' aria-label='Previous' class='page-link'><span aria-hidden='true'>»</span><span class='sr-only'>Next</span></a></li>");
										}
