...
//	}
	...
	public ArrayList<Product> getListProductByCategoryAndPage(long category_id, int page, int maxInEachPage)
			throws SQLException {
		Connection connection = DBConnection.getConnection();
...
//				System.out.println(prd.getName());
	...
	public int getNumberOfPageListProductByCategory(long category_id, int maxInEachPage)
			throws SQLException {
		Connection connection = DBConnection.getConnection();
//		String sql2 = "SELECT * FROM `database`.products WHERE category_id = '" + category_id + "' LIMIT '"
//				+ page * maxInEachPage + "' , '" + maxInEachPage + "'";
